object Versions {
    ...
    //Business Modules
    const val uikitVersion = "6.4.0"
    const val bduiVersion = "1.0.3"
    const val placesVersion = "1.0.1"
    const val networkVersion = "6.3.0"
    const val productsVersion = "6.2.4"
    const val homeVersion = "6.3.8"
    ...
    //map
    const val mapVersion = "18.1.0"
    const val mapComposeVersion = "2.11.1"
...
object Deps {
    ...
    object Arch {
        ...
        const val okHttpJsonMock =
            "com.github.mirrajabi:okhttp-json-mock:${Versions.okHttpJsonMockVersion}"
        ...
        const val zxingAndroid =
            "com.journeyapps:zxing-android-embedded:${Versions.zxingAndroidVersion}"
        ...
        const val map = "com.google.android.gms:play-services-maps:${Versions.mapVersion}"
        const val mapCompose = "com.google.maps.android:maps-compose:${Versions.mapComposeVersion}"
        const val mapLocation =
            "com.google.android.gms:play-services-location:${Versions.mapLocationVersion}"
